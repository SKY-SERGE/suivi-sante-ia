---
applyTo: "**/*.css,**/*.vue,**/*.blade.php,**/*.tsx,**/vite.config.js"
description: "Tailwind CSS 4 rules and best practices"
---
...
- Create custom variants with `@variant` directive:
  ...
  ```html
  <!-- Usage -->
  <button class="pointer-coarse:p-4">Larger padding on touch devices</button>
  ```

...
function Execute-SQLFile {
    ...
    try {
        ...
        # URL de l'API REST de Supabase pour exécuter du SQL
        $apiUrl = "$Url/rest/v1/rpc/exec_sql"
...
function Test-SupabaseConnection {
    ...
    Write-Info "Test de la connexion à Supabase..."
...
if ([string]::IsNullOrEmpty($ServiceKey)) {
    ...
    Write-Warning "⚠️  Attention: N'utilisez JAMAIS la service_role key côté client!"
...
Write-Warning "⚠️  Cette opération va modifier la base de données Supabase!"
